		    		...
		    		<table class="table_01">
		    			<tr>
		    				...
		    				<td class="orange_button">
		    					<button type="button" class="orange two_second">订票</button>
		    				</td>
		    			</tr>
		    		</table>
								...
								<div class="col-md-7">
									...
									<div class="col-md-6 jp_gs-l">
										<div class="col-md-12 jp_gs" style="border-bottom: 1px dashed rgba(0, 0, 0, 0.22);">
											...
											onclick="lyxyuding(this,'去程机票id','返程机票id','PriorityPackage')">
											<a href="<?php  echo Yii::$app->urlManager->createUrl(['flight/dctwo', array('qid'=>$f['FlightDynamicID'],'fid'=>$f['FlightWfid'],'Wfgoid'=>$f['Wfgoid'],'Wftoid'=>$f['Wftoid'],'wftime'=>$f['FlightWftime'])]);?>">选定</a></div>
										</div>
										<div class="col-md-12 jp_gs">
											<span>普通预订</span><div class="btn btn-danger">选定</div>
										</div>
									</div>
								</div>
							</div>
