								...
								<div class="col-md-7">
									...
									<div class="col-md-6 jp_gs-l">
										<div class="col-md-12 jp_gs" style="border-bottom: 1px dashed rgba(0, 0, 0, 0.22);">
											<span>普通预订</span><a href="<?php  echo Yii::$app->urlManager->createUrl(['flight/multtwo', array('qid'=>$f['FlightDynamicID'],'fid'=>$f['FlightWfid'],'Wfgoid'=>$f['Wfgoid'],'Wftoid'=>$f['Wftoid'],'wftime'=>$f['FlightWftime'],'serars'=>$serars)]);?>"><div class="btn btn-danger">选定</div></a>
										</div>
