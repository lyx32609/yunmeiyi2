...
?>
		    ...
		    <div class="main_container">
		    	<div class="order_left_main">
		    		<div id="order_div01">
		    			...
		    			<form  method="post" action="<?php  echo Yii::$app->urlManager->createUrl('flight/pays') ?>"  onSubmit="return next('<?=$flightone['FlightDynamicID'].','.$flighttwo['FlightDynamicID']?>')">
		    					...
		    					<div class="order_top_info">
		    						...
		    						<div class="pass_name">
		    							<ul class="passenger_name_ul">
		    								...
		    								<li>
		    									<a onclick="addpassenger($u['PassengerName'],$u['IDType1'],$u['Identity1'],quhao,$u['PassengerPhone'])" href="#" class="paddes_name"><?=$u['PassengerName']?></a>
		    								</li>
		    								<?php }?>
		    							</ul>
		    						</div>
	<script>
		function addpassenger(username,idtype1,idnum1,quhao,tel,idtype2,idnum2){
		    		...
		    		<div class="main_right_content">
		    			<div id="journey">
		    					...
		    					<div class="fli_det">
		    						<div class="row update_row">
		    							<div class="col-xs-4 public">
		    								<div class="text_align_right"><?=substr($flightone['DepartTime'],0,5)?></div>
		    								<div  class="text_align_right"><?=$flightone['DepartAirport']?></div>
		    							</div>
		    							<div class="col-xs-4 fli_tit_span">
		    								<div>
		    								<i class="iconfont icon-shijian"></i>
		    								<?=$flightone['RealDuration']?>m
		    								</div>
		    							...
		    							<div class="col-xs-4 public">
		    								<div class="text-align_left"><?=substr($flightone['ArriveTime'],0,5)?></div>
		    								<div class="text-align_left"><?=$flightone['ArriveAirport']?></div>
		    							</div>
		    						</div>
		    					</div>
		    				<div class="journey_info xia_info">
		    					...
		    					<div class="j_info_top">
		    						<span class="order_go"><?php if($type=="M"){?>第二程<?php }else{?>返<?php }?></span>
		    						<div class="order_data_time">
		    							<?=substr($flighttwo['DepartDate'],5,5)?>
		    							<span class="oreder_week public">
		    								<?=$flighttwo['Week']?>
		    							</span>
		    						</div>
		    						<div class="take_off_city public">
		    							<?=$flighttwo['DepartCity']?>
		    						</div>
		    						<div class="icon_take public">
		    							<i class="iconfont icon-chufadaodaxiao"></i>
		    						</div>
		    						<div class="Arrive_city public">
		    							<?=$flighttwo['ArriveCity']?>
		    						</div>
		    						
		    					</div>
		    					<div class="fli_tit">
		    						<span class="public fli_tit_span fli_01">
		    							<img src="/frontend/web/<?=$flighttwo['PicUrl']?>" width="16px" height="16px" />
		    							 <?=$flighttwo['AirlineShortName']?>
		    						</span>
		    						<span class="public fli_tit_span fli_02">
		    							<?=$flighttwo['PlaneModelName']?>
		    						</span>
		    						<span class="public fli_tit_span fli_03">经济舱</span>
		    					</div>
		    					<div class="fli_det">
		    						<div class="row update_row">
		    							<div class="col-xs-4 public">
		    								<div class="text_align_right"><?=substr($flighttwo['DepartTime'],0,5)?></div>
		    								<div  class="text_align_right"><?=$flighttwo['DepartAirport']?></div>
		    							</div>
		    							<div class="col-xs-4 fli_tit_span">
		    								<div>
		    								<i class="iconfont icon-shijian"></i>
		    								<?=$flighttwo['RealDuration']?>m
		    								</div>
		    								<div class="icon-qifei">
			    								<i class="iconfont icon-lianjiexuxian"></i>
			    								<i class="iconfont icon-qifei"></i>
		    							...
		    							<div class="col-xs-4 public">
		    								<div class="text-align_left"><?=substr($flighttwo['ArriveTime'],0,5)?></div>
		    								<div class="text-align_left"><?=$flighttwo['ArriveAirport']?></div>
		    							</div>
		    						</div>
		    					</div>
		    				</div>
	    					     ...
	    					     <div class="route">
			    					<div class="cos_det_top">
			    						<div class="cos_top_content">
			    							<span>
			    								返程成人套餐
			    								<i class="iconfont icon-xiala order_jiantou01" id="iconfont_jiantou01"></i>
			    							</span>
			    							<span class="up_da" data-toggle="popover" data-placement="top" data-content="<img src='images/gaiqi.png' width='340px' height='170px'/>">
			    								免费改期
			    							</span>
	...
	<script>
		...
		$(function(){	
			...
			$("#iconfont_jiantou01").click(function(){
							  if($(this).parent().parent().parent().siblings(".roder_ul_info").css("display")=="block"){
							  	$(this).parent().parent().parent().siblings(".roder_ul_info").hide();
							  	$(this).removeClass("order_jiantou01");
							  }else{
