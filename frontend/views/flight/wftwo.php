		 ...
		 <div class="chakan_container">
		   ...
		   <div class="jp_center">
		    ...
		    <?php foreach ($flights as $f) {?> 
		    	<div class="li_div">
		    		<ul class="table_01 table_display_none">		    			
		    				<li class="logo">
		    					<div class="logo_samll">
		    						<img class="img_name" src="/frontend/web/<?=$wfafter['PicUrl']?>"/>
								...
								<div class="col-md-7">
									...
									<div class="col-md-6 jp_gs-l">
										<div class="col-md-12 jp_gs" style="border-bottom: 1px dashed rgba(0, 0, 0, 0.22);">
											<span>普通预订</span><a href="<?php  echo Yii::$app->urlManager->createUrl(['flight/orders','FlightDynamicID'=>$wfafter['FlightDynamicID'].','.$f['FlightDynamicID'],'type'=>'S']) ?>"><div class="btn btn-danger">预订</div></a>
										</div>
										<div class="col-md-12 jp_gs">
											<span>普通预订</span><a><div class="btn btn-danger">预订</div></a>
										</div>
									</div>
								</div>
							</div>
